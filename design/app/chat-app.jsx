...
const {
  ...
  initStore, saveStore, newId, getModel, pathToRoot, childrenOf, creditsInPath, fmt,
  roughTokens, calculateCredits,
...
const ChatApp = () => {
  ...
  const send = async () => {
    ...
    const model = getModel(prefs.model);
                  ...
                  {thinking && (
                    <div className="msg assistant">
                      <div className="m-head">
                        <span className="m-avatar" style={{ background: getModel(prefs.model).color }}>{getModel(prefs.model).initials}</span>
                        <span>{getModel(prefs.model).name}</span>
                      </div>
