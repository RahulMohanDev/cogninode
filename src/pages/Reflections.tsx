              ...
              <div className="tw:grid tw:grid-cols-[300px_1fr] tw:gap-5 tw:items-start">
                ...
                <div className="tw:flex tw:flex-col tw:gap-2 tw:min-w-0">
                  <div className="tw:relative">
                    ...
                    <input
                      className="tw:w-full tw:py-[9px] tw:pr-3 tw:pl-[34px] tw:border tw:border-line tw:bg-bg tw:rounded-app-sm tw:text-[13px] tw:outline-none tw:transition-[border-color] tw:duration-[120ms] tw:ease-[ease] tw:focus:border-ink-3 tw:placeholder:text-ink-3"
                      type="text"
